...
2. [Layouts](#layouts)
	1. Category 1️⃣: [xkb/kbd-Only Layouts](#xkb-kbd-only-layouts) (for use with the default kernel driver, not compatible with the userspace driver)
	...
	2. Category 2️⃣: [Userspace Driver-Only Layouts](#userspace-driver-only-layouts) (custom userspace drivers, no xkb/kbd components)
		1. [**Extended Simple**](#extended-simple) (number row symbols on Fn, F11, PageUp/Down)
	3. Category 3️⃣: [Full Layouts](#full-layouts) (custom drivers + xkb/kbd layouts for maximum customisability)
